...
public class ConnectionLoader extends AsyncTaskLoader<Boolean> {

    public ConnectionLoader(@NonNull Context context) {
        super(context);
    }
    ...
    public Boolean loadInBackground() {
        return isReachableByTcp(SERVER_ADDRESS, SERVER_PORT);
    }
}
